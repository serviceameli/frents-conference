...
import { ArrowUpRight, ArrowRight, ArrowDown, Boxes, FolderOpen, Repeat2, UsersRound, Check, Gift, Plus, Smartphone, PackageCheck, CalendarDays, MapPin, Download, LoaderCircle, Sparkles, X, Heart, Search, Leaf, LockKeyhole, Warehouse, Store, Clock3 } from "lucide-react";
...
export default function Home() {
  ...
  function scrollToService() {
    ...
    if (!detail) return;
    const content = detail.querySelector<HTMLElement>(".service-content[data-state=active]") || detail;
